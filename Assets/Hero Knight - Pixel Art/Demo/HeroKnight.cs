...
public class HeroKnight : MonoBehaviour {
   ...
   // [SerializeField] bool       m_noBlood = false;
    ...
    [SerializeField] float attackCooldown = 0.5f; // Cooldown time between attacks
    ...
    void Update ()
    {
        ...
        //Attack
           if(Input.GetMouseButtonDown(0) && attackTimer <= 0 && !m_rolling)
        {
            m_currentAttack=1;
        ...
        if (Input.GetKeyDown("q") && attackTimer <= 0)
        {    
            m_currentAttack = 2;
        ...
        if(Input.GetKeyDown("r")&& attackTimer <= 0)
        {   m_currentAttack = 3;
